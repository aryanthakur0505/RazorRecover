        ...
        {error ? (
          ...
          <>
            ...
            <p className="text-xs text-muted-foreground">
              "Est. Incremental Net" is a <strong>projection</strong>, not a measured fact — we can
              never run two different actions on the same real payment, so the deterministic
              engine's outcome is estimated using the same recovery-score probability model the
              rest of this app already relies on. Only resolved disagreements (a real outcome to
              compare against) count toward it.
            </p>
